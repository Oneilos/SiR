...
namespace LinkR\Bundle\GroupBundle\Controller;

use LinkR\Bundle\GroupBundle\Model\Group;
use LinkR\Bundle\GroupBundle\Model\GroupQuery;
...
class AdminController extends Controller
{
    ...
    public function listAction(Request $request)
    {
        ...
        return $this->render('LinkRGroupBundle:Admin:list.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->renderForm(
            $request, $group, 'LinkRGroupBundle:Admin:new.html.twig'
        );
    }
    ...
    {
        return $this->renderForm(
            $request, $group, 'LinkRGroupBundle:Admin:edit.html.twig'
        );
    }
    ...
    protected function renderForm(Request $request, Group $group, $template)
    {
        ...
        if ($request->request->has($form->getName())) {
            if ($this->get('LinkR_group.form.group_handler')->handle($form, $request)) {
        ...
        return $this->render($template, array(
            ...
            'locales' => $this->container->getParameter('LinkR_group.managed_locales')
        ));
    }
