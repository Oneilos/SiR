...
namespace LinkR\Bundle\UserBundle\Command;
...
use LinkR\Bundle\UserBundle\Model\PersonQuery;
use LinkR\Bundle\UserBundle\Model\PersonTypeQuery;
...
use LinkR\Bundle\MissionBundle\Model\ClientQuery;
...
class ImportConsultantsCommand extends ContainerAwareCommand
{
    ...
    {
        $this->setName("LinkR:consultants:import")
    ...
    public function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        foreach ($consultantList as $consultantData) {
            ...
            $return = $this->getContainer()->get('LinkR_user.domain.mission_order')->synchronize(
