...
use LinkR\Bundle\UserBundle\Model\Agency;
...
class ImportInternalsCommand extends ContainerAwareCommand
{
    ...
    {
        $this->setName("LinkR:internals:import")
    ...
    public function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        // "hard" trigram
        $hardTrigrams = array(
            'edegand@LinkR.fr'    => 'EDE',
            'edeschamps@LinkR.fr' => 'EMD',
            'adupessey@LinkR.fr'  => 'AND',
            'adupuy@LinkR.fr'     => 'ADU',
            'mdefromont@LinkR.fr' => 'MDF',
            'asadellah@LinkR.fr'  => 'AIS'
        );
