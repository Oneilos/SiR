...
class InternalController extends Controller
{
    ...
    public function timelineAction(Request $request, $Id, $Url)
    {
        ...
        return $this->render('LinkRUserBundle:Internal:timeline.html.twig', array(
            'internal' => $user
        ));
    }
    ...
    public function consultantsListAction(Request $request, Internal $internal)
    {
        ...
        return $this->render('LinkRUserBundle:Internal:consultants.html.twig', array(
    ...
    public function intercontractsAction(Request $request, Internal $internal)
    {
        ...
        return $this->render('LinkRUserBundle:Internal:intercontracts.html.twig', array(
            'internal'    => $internal,
    ...
    public function missionsListAction(Request $request, Internal $internal)
    {
        ...
        return $this->render('LinkRUserBundle:Internal:missions.html.twig', array(
            'missions' => $missions
        ));
    }
    ...
    public function teamPastTasksAction(Request $request, Internal $internal)
    {
        ...
        return $this->render('LinkRUserBundle:Internal:team_past_tasks.html.twig', array (
