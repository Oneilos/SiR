...
class AdminConsultantController extends Controller
{
    ...
    protected function processFilters(Request $request, ConsultantQuery $query)
    {
        ...
        $user = $this->getUser();
        $form = $this->get('LinkR_user.admin.consultant_filters_form');
    ...
    public function listAction(Request $request)
    {
        ...
        return $this->render('LinkRUserBundle:AdminConsultant:list.html.twig', array(
            'user'        => $internal,
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->renderForm($request, $consultant, 'LinkRUserBundle:AdminConsultant:new.html.twig');
    }
    ...
    {
        return $this->renderForm($request, $consultant, 'LinkRUserBundle:AdminConsultant:edit.html.twig');
    }
    ...
    public function renderForm(Request $request, Consultant $consultant, $template)
    {
        ...
        if ($request->request->has($form->getName())) {
            if ($this->get('LinkR_user.admin.consultant_form_handler')->handle($form, $request)) {
