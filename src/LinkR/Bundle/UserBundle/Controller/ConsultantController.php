...
namespace LinkR\Bundle\UserBundle\Controller;

use LinkR\Bundle\UserBundle\Model\Consultant;
...
use LinkR\Bundle\DocumentBundle\Model\DocumentQuery;
...
class ConsultantController extends Controller
{
    ...
    public function timelineAction(Request $request, $Id, $Url)
    {
        ...
        return $this->render('LinkRUserBundle:Consultant:timeline.html.twig', array(
            'user'  => $user,
            'tasks' => $tasks
        ));
    }
    ...
    public function documentsAction(Request $request, Consultant $consultant)
    {
        ...
        return $this->render('LinkRUserBundle:Consultant:documents.html.twig', array(
    ...
    public function missionsAction(Request $request, Consultant $consultant)
    {
        ...
        return $this->render('LinkRUserBundle:Consultant:missions.html.twig', array(
            'consultant'    => $consultant,
    ...
    public function changeMissionAction(Request $request, Consultant $consultant)
    {
        ...
        $handler = $this->get('LinkR_user.form.change_mission_handler');
        ...
        return $this->render('LinkRUserBundle:Consultant:change_mission.html.twig', array(
            'consultant' => $consultant,
