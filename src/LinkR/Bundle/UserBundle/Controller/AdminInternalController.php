...
class AdminInternalController extends Controller
{
    ...
    protected function processFilters(Request $request, InternalQuery $query)
    {
        ...
        $form    = $this->get('LinkR_user.admin.internal_filters_form');
    ...
    public function listAction(Request $request, $page = 1)
    {
        ...
        $internalsQuery = InternalQuery::create()
            ...
            // ->distinct('Id')
            // ->groupByClass('LinkR\Bundle\UserBundle\Model\Internal')
        ...
        return $this->render('LinkRUserBundle:AdminInternal:list.html.twig', array (
            'user'      => $internal,
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->renderForm(
            $request,
            $internal,
            'LinkRUserBundle:AdminInternal:new.html.twig'
        );
    }
    ...
    public function editAction(Request $request, Internal $internal)
    {
        return $this->renderForm(
            $request,
            $internal,
            'LinkRUserBundle:AdminInternal:edit.html.twig'
        );
    }
    ...
    public function renderForm(Request $request, Internal $internal, $template)
    {
        ...
        if ($request->request->has($form->getName()) &&
            $this->get('LinkR_user.admin.internal_form_handler')->handle($form, $request) ) {
