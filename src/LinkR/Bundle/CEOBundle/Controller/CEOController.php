...
namespace LinkR\Bundle\CEOBundle\Controller;
...
class CEOController extends Controller
{
    public function CompanyInformationsAction(Request $request)
    {
        ...
        return $this->render('LinkRCEOBundle:CEO:company_infos.html.twig', array(
            'data' => $data
        ));
    }
    ...
    public function CrhWithLateTasksAction(Request $request)
    {
        ...
        return $this->render('LinkRCEOBundle:CEO:internals_late.html.twig', array(
