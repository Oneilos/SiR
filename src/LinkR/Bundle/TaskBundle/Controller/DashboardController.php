...
class DashboardController extends Controller
{
    ...
    public function userDashboardAction(Request $request, $page = 1)
    {
        ...
        if ($codeType == 'dir')
        {
            return $this->render('LinkRTaskBundle:Dashboard:da_dashboard.html.twig', array(
                'user'  => $this->getUser()
             ));
        }
        elseif($codeType == 'pdg')
        {
            return $this->render('LinkRTaskBundle:Dashboard:pdg_dashboard.html.twig', array(
                'user'  => $this->getUser()
            ));
        }

            return $this->render('LinkRTaskBundle:Dashboard:user_dashboard.html.twig', array(
                'user'  => $this->getUser()
            ));
    ...
    public function dashboardTimelineAction(Request $request, $tasks = array(), $userId = null)
    {
        ...
        return $this->render('LinkRTaskBundle:Dashboard:dashboardTimeline.html.twig', array(
    ...
    protected function getTemporalKey(Task $task)
    {
        ...
        $temporalTool = $this->get('LinkR_task.tools.temporal');
