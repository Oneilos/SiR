...
namespace LinkR\Bundle\TaskBundle\Controller;
...
class TaskController extends Controller
{
    ...
    public function workflowHistoryAction(Request $request)
    {
        ...
        return $this->render('LinkRTaskBundle:Task:workflow_detail.html.twig', array(
            'workflow' => $workflow,
            'tasks'    => $tasks,
    ...
    {
        $form = $this->get('LinkR.task.form.differ');

        if ($request->request->has($form->getName())) {
            $this->get('LinkR.task.form.differ_handler')->handle($form, $request);
        ...
        return $this->render('LinkRTaskBundle:Task:differ.html.twig', array(
            'form' => $form->createView()
        ));
    }
    ...
    public function workflowDocumentsAction(Request $request, $workflowId)
    {
        ...
        return $this->render('LinkRTaskBundle:Task:workflow_documents.html.twig', array(
