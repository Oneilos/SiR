...
namespace LinkR\Bundle\MissionBundle\Controller;
...
class AdminMissionController extends Controller
{
    ...
    protected function processFilters(Request $request, MissionQuery $query)
    {
        ...
        $user = $this->getUser();
        $form = $this->get('LinkR_mission.form.mission_filters');
    ...
    public function listAction(Request $request)
    {
        ...
        return $this->render('LinkRMissionBundle:AdminMission:list.html.twig', array(
    ...
    public function editAction(Request $request, Mission $mission)
    {
        return $this->renderForm(
            ...
            $mission,
            'mission_edit_form',
            'LinkRMissionBundle:AdminMission:edit.html.twig'
        );
    }
    ...
    public function modalAction(Request $request, Mission $mission = null)
    {
        ...
        return $this->renderForm(
            ...
            $mission,
            'mission_new_form',
            'LinkRMissionBundle:AdminMission:modal.html.twig'
        );
    }
    ...
    protected function renderForm(Request $request, Mission $mission, $formType, $template = null)
    {
        ...
        if ($request->request->has($form->getName())) {
            $success = $this->get('LinkR_mission.form.mission_handler')->handle($form, $request);
        }
