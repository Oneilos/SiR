...
namespace LinkR\Workflow\MissionMonitoringBundle\Form\Type;
 ...
 * @see LinkRWorkflowMissionMonitoringBundle/Resources/workflows/meeting.xml
 */
class ReportType extends AbstractType
{
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        return $resolver->setDefaults(array(
            'data_class' => 'LinkR\Workflow\MissionMonitoringBundle\Model\MissionOrderReport'
        ));
    }
